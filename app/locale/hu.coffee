...
#    global_title: "Join Our Global Community of Learners and Educators"
    global_subtitle1: "Tanulók"
#    global_subtitle2: "Lines of Code"
    global_subtitle3: "Tanárok"
    global_subtitle4: "Országok"
...
#    ozaria_china_blurb: ""
    ...
    try_ozaria: "Próbáld ki az Ozariát"
    explore_codecombat: "CodeCombat felfedezése"
    explore_ai_league: "MI Liga felfedezése"
    explore_ozaria: "Ozaria felfedezése"
    explore_online_classes: "Online osztályok felfedezése"
...
#    codecombat_home_blurb: "__codecombatHome__ offers your child a fun and engaging way to advance their coding skills. With access to over 530 levels and exclusive features like pets, premium-only items, and heroes, your child can fully immerse themselves in the world of coding. They can even design games to challenge their friends, build websites and apps to share, and create private teams to compete on a group leaderboard, all in a safe and interactive environment that encourages learning and socialization."
    codecombat_home: "CodeCombat kezdőlap"
    for_educators: "Oktatóknak"
    for_parents: "Szülőknek"
    for_everyone: "Mindenkinek"
    for_students: "Tanulóknak"
    for_individuals: "Egyéneknek"
    for_libraries: "Könyvtáraknak"
    for_partners: "Partnereknek"
...
#    what_our_customers_are_saying: "What Our Customers Are Saying"
    game_based_learning: "Játék-alapú tanulás"
#    unique_approach_blurb: "With our unique approach, students embrace learning as they play and write code from the very start of their adventure, promoting active learning and a growth mindset."
    text_based_coding: "Szövegalapú kódolás"
...
#    global_community: "Join Our Global Community"
    million: "__num__ millió"
    billion: "__num__ milliárd"
    meta_keywords_podcast: "CodeCombat, python, javascript, Coding Games, podcast, edtech"
    coco_worlds_header: "CodeCombat világok"
#    coco_worlds_description: "Embark on a 3D coding adventure in Roblox, where you can program pets, play with friends, and develop games all while playing one. Join the CodeCombat community and unleash your creativity in the metaverse!"
    coco_worlds_button: "CodeCombat világok felfedezése"
...
#    my_units: "My Units"
    ...
    parent: "Szülők"
    faq: "GYIK"
    return_coco: "Vissza CodeCombathoz"
    classes: "Osztályok"
    term_of_service: "Felhasználási feltételek"
    esports: "Esportok"
...
#    funding_resources_guide: "Funding Resources Guide"
    partnerships: "Partnerség"
    podcast: "Podcastunk"
#    dashboard: "Dashboard"
#    products: "Products"
#    live_online_classes: "Live Online Classes"
    codecombat_home: "CodeCombat kezdőoldal"
...
#    research_impact: "Research - Impact"
  ...
  diplomat_suggestion:
    title: "Segíts lefordítani a CodeCombat-ot!" # This shows up when a player switches to a non-English language using the language selector.
  ...
  new_home_faq:
    what_programming_languages: "Milyen programozási nyelvek érhetőek el?"
    python_and_javascript: "Jelenleg a Pythont és a JavaScriptet támogatjuk."
    why_python: "Miért válaszd a Pythont?"
    why_python_blurb: "A Python egyszerre kezdőbarát és jelenleg nagyvállalatok (például a Google) által használt program. Ha fiatalabb vagy, esetleg első alkalommal tanulsz róla, erősen ajánljuk a Pythont.."
    why_javascript: "Miért válaszd a JavaScriptet?"
    why_javascript_blurb: "JA JavaScript a web nyelve, és szinte minden weboldalon használják. Akkor válaszd inkább a JavaScriptet, ha webfejlesztést is tervezel tanulni. Megkönnyítettük a diákok számára a Pythonról a JavaScript-alapú webfejlesztésre való átállást is.."
    javascript_versus_python: "A JavaScript szintaxisa egy kicsit nehezebb a kezdők számára, mint a Pythoné, ezért ha nem tudsz dönteni a kettő között, akkor a Pythont ajánljuk.."
    how_do_i_get_started: "Hogyan fogjak hozzá?"
    getting_started_1: "Hozd létre a tanári fiókodat"
    getting_started_2: "Hozz létre egy osztályt"
    getting_started_3: "Adj hozzá diákokat"
    getting_started_4: "Dőlj hátra és figyeld, ahogy a diákjaid szórakozva tanulnak kódolni"
    main_curriculum: "Használhatom a CodeCombatot vagy az Ozariát fő tananyagként?"
    main_curriculum_blurb: "Abszolút! Sok időt töltöttünk oktatási szakemberekkel való konzultációval, hogy tantermi tananyagot és anyagokat dolgozzunk ki kifejezetten olyan tanárok számára, akik a CodeCombatot vagy az Ozariát használják, anélkül, hogy maguk is rendelkeznének előzetes számítástechnikai tapasztalattal. Sok iskola alkalmazza a CodeCombat és/vagy az Ozaria programot fő informatikai tananyagként.."
    clever_instant_login: "Támogatja a CodeCombat és az Ozaria a Clever Instant Logint?"
    clever_instant_login_blurb: "Igen! Nézd meg a __clever__ oldalunkat további részletekért az elkezdéshez."
    clever_integration_faq: "Clever integráció GYIK"
    google_classroom: "Mi a helyzet a Google Classroommal?"
    google_classroom_blurb1: "Igen! Győződj meg róla, hogy a Google Single Sign-On (SSO) modult használod a tanári fiókodhoz való bejelentkezéshez. Ha már rendelkezel fiókkal a Google e-mail címedet használva, a következő alkalommal a Google SSO modal segítségével jelentkezz be. Az Osztály létrehozása modalban megjelenik a Google Classroom összekapcsolásának lehetősége. Jelenleg csak a Google Classroomon keresztül történő beosztást támogatjuk."
    google_classroom_blurb2: "Megjegyzés: a Google SSO-t használva legalább egyszer be kell jelentkezned vagy be kell jelentkezned ahhoz, hogy megjelenjen a Google Classroom integrációs lehetőség."
    how_much_does_it_cost: "Mennyibe kerül az összes elérhető tanfolyam és forrás elérése?"
    how_much_does_it_cost_blurb: "Megoldásokat szabunk az iskolák és körzetek számára, és együttműködünk veled, hogy megértsük a felhasználási esetedet, a kontextust és a költségvetést. További részletekért lépj velünk kapcsolatba! A CARES Act finanszírozási forrásainak, például az ESSER-nek és a GEER-nek a kihasználásáról lásd a __finanszírozás__ című oldalunkat."
    recommended_systems: "Van ajánlott böngésző és operációs rendszer?"
    recommended_systems_blurb: "A CodeCombat és az Ozaria legjobban legalább 4 GB RAM-mal rendelkező számítógépeken, modern böngészővel, például Chrome, Safari, Firefox vagy Edge böngészővel fut. A 2 GB RAM-mal rendelkező Chromebookokon kisebb grafikai problémák jelentkezhetnek a későbbi kurzusok során. Diákonként legalább 200 Kbps sávszélesség szükséges, bár 1+ Mbps ajánlott."
    other_questions: "Ha bármilyen egyéb kérdésed van, kérjük, __contact__."
    see_faq_prefix: "További tudnivalók a"
    see_faq_link: "gyakran ismétlődő kérdésekben a súgóközpontunkban"
    see_faq_suffix: "."
...
#    video_title: "__video__ | Video Level"
    ...
    anon_signup_title_1: "A CodeCombatban van "
